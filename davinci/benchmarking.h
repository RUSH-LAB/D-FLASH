...
#define BASEFILE		"$SHARED_SCRATCH/ncm5/dataset/webspam/trigram.svm"
#define GTRUTHINDICE	"$SHARED_SCRATCH/ncm5/dataset/webspam/webspam_tri_gtruth_indices.txt"
#define GTRUTHDIST		"$SHARED_SCRATCH/ncm5/dataset/webspam/webspam_tri_gtruth_distances.txt"
